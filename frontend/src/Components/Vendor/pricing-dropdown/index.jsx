...
const PricingDropdown = ({ dropdownRef, vendor }) => {
    console.log(vendor, 'vendor');

    return (
        <div ref={dropdownRef} className=' absolute top-[417px] md:top-32 mt-1 right-0 lg:right-36 bg-white shadow-lg border border-grey rounded-b-md z-40  py-2 '>
